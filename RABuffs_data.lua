...
RAB_Buffs = 	{
			...
			greaterarcane={name="Greater Arcane Elixir",textures={"INV_Potion_25"},castClass="Potions",type="aura"},
                        fireelixir={name="Fire Power Elixir",textures={"INV_Potion_33"},castClass="Potions" ,type="aura"},	
			...
			tuber={name="Runn Tum Tuber Surprise",textures={"INV_Misc_Organ_03"},castClass="Food-like buffs" ,type="aura"},
                        ...
                        bronze={name="Bronze Disease!",textures={"INV_Misc_Head_Dragon_Bronze"},castClass="Bosses' Debuffs" ,type="debuff"},
                        timelapse={name="Time Lapse!",textures={"Spell_Arcane_PortalOrgrimmar"},castClass="Bosses' Debuffs" ,type="debuff"},
                        crusader={name="Crusader Procs",textures={"Spell_Holy_BlessingOfStrength"},castClass="MISC-2" ,type="aura"},
                        lip={name="LIP",textures={"INV_Hammer_02"},castClass="MISC-2" ,type="aura"},
                        innerv={name="Innervate",textures={"Spell_Nature_Lightning"},castClass="MISC-2" ,type="aura"},
                        feared={name="Feared",textures={"Spell_Shadow_PSychicScream"},castClass="Debuff" ,type="debuff"},
                        drinking={name="Currently Drinking: ",textures={"INV_Drink_18"},castClass="MISC-2" ,type="aura"},
                        renew={name="Renew",textures={"Spell_Holy_Renew"},castClass="MISC-2" ,type="aura"},
